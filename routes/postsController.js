 ...
 */ 
 ...
 router.put("/user/update/:tags/:mail", (req,res)=>{// Update : De mbola très bien koa
...
router.delete('/user/delete/:tags/:id',(req,res)=>{// Delete : Ok
    ...
    User.deleteMany(query, function(err, obj) {
        if (err) throw err;
        res.send(`The user with the ${req.params.tags} : ${req.params.id} has been deleted from the database.`);
      });
});
 ...
 */ 
 ...
 router.put("/admin/update/:tags/:email", (req,res)=>{// Update : De mbola très bien koa
 ...
 */ 
 ...
 router.post('/customer/add', (req,res)=>{ //Insert : Très bien koa
 ...
 *          description : A successful response
 */
 router.get('/customer',(req,res)=>{//Select all users: OK
 ...
 *          description: Items not found
 */
router.get('/customer/:tags/:id',(req,res)=>{//Select one article : OK
    let query = {};
    query[req.params.tags] = req.params.id
 ...
 */ 
 ...
 router.put("/customer/update/:mail", (req,res)=>{// Update : De mbola très bien koa
 ...
 *          description: Items not found
 */
router.delete('/customer/delete/:tags/:id',(req,res)=>{// Delete : Ok
    let query = {};
    query[req.params.tags] = req.params.id
